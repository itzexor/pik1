...
typedef enum {
    PIK_CONTROL_ACTION_RESTART_PIK1 = 1,
    PIK_CONTROL_ACTION_REBOOT = 2,
    PIK_CONTROL_ACTION_POWEROFF = 3,
    PIK_CONTROL_ACTION_STATUS = 4,
    PIK_CONTROL_ACTION_RESTART_WIFI = 5,
    PIK_CONTROL_ACTION_RESTART_KLIPPER = 6,
